...
// let jobSection1 = document.getElementById("job-Section-1") as HTMLElement;
// let jobSection2 = document.getElementById("job-Section-2") as HTMLElement;
// let jobSection3 = document.getElementById("job-Section-3") as HTMLElement;

// let sortSlider1 = document.getElementById("sortSlider1") as HTMLElement;
// let sortSlider2 = document.getElementById("sortSlider2") as HTMLElement;
// let sortSlider3 = document.getElementById("sortSlider3") as HTMLElement;

// let currentSectionjob = 1;

// leftGoSlider.addEventListener("click", function () {
//   if (currentSectionjob === 1) {
//     jobSection1.classList.add("hiddenKone");
//     jobSection2.classList.remove("hiddenKone");
//     jobSection3.classList.add("hiddenKone");

//     sortSlider1.classList.remove("changeColor");
//     sortSlider2.classList.add("changeColor");
//     sortSlider3.classList.remove("changeColor");

//     currentSectionjob = 2;
//   } else if (currentSectionjob === 2) {
//     jobSection1.classList.add("hiddenKone");
//     jobSection2.classList.add("hiddenKone");
//     jobSection3.classList.remove("hiddenKone");

//     sortSlider1.classList.remove("changeColor");
//     sortSlider2.classList.remove("changeColor");
//     sortSlider3.classList.add("changeColor");

//     currentSectionjob = 3;
//   } else if (currentSectionjob === 3) {
//     jobSection1.classList.remove("hiddenKone");
//     jobSection2.classList.add("hiddenKone");
//     jobSection3.classList.add("hiddenKone");

//     sortSlider1.classList.add("changeColor");
//     sortSlider2.classList.remove("changeColor");
//     sortSlider3.classList.remove("changeColor");
